...
public class DescriptionFragment extends StateSaverFragment {
    ...
    private void setupDescription() {
        ...
        if (description == null || isEmpty(description.getContent())
            ...
            binding.detailCopyDescriptionButton.setVisibility(View.GONE);
            return;
        }
        ...
        binding.detailCopyDescriptionButton.setOnClickListener(v -> copyDescriptionToClipboard());
        binding.detailDescriptionView.setOnLongClickListener(v -> {
    ...
    private void copyDescriptionToClipboard() {
        final Description description = streamInfo.getDescription();
        if (description != null && !isEmpty(description.getContent())) {
            ShareUtils.copyToClipboard(requireContext(), description.getContent());
        }
    }
